...
::backdrop {
  ...
  .bg-custom-AdaMapBlue {
  --tw-bg-opacity: 1;
  background-color: rgb(134 179 204 / var(--tw-bg-opacity));
}
  .bg-destructive {
  ...
  .bg-\[url\(\'\/assets\/logoLABIS\.png\'\)\] {
  background-image: url('/assets/logoLABIS.png');
}
  .bg-cover {
  ...
  .hover\:bg-custom-AdaMapBlueDark:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(19 71 120 / var(--tw-bg-opacity));
}
  ...
  .hover\:text-custom-AdaMapBlueDark:hover {
  --tw-text-opacity: 1;
  color: rgb(19 71 120 / var(--tw-text-opacity));
}
